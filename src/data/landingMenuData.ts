  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Pacific halibut from Alaskan waters, seared in clarified butter until a golden crust forms. Served with brown butter sauce, capers, haricots verts, and roasted fingerling potatoes. A dish that exemplifies restraint, allowing quality ingredients to speak for themselves.",
        tags: ["Seafood", "Light"],
        image:
          "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=800&q=80",
        images: [
      ...
      },
      {
        ...
        preparationNotes:
          "Braised for 3–4 hours before service. The bone marrow in the center is meant to be scooped out and enjoyed. The gremolata is prepared fresh to order. This is comfort food elevated to fine dining.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        preparationNotes:
          "Set for several hours before service. The panna cotta should have a gentle wobble indicating its tender texture. Light enough to enjoy after a heavy meal. The passion fruit coulis provides tartness to balance the cream.",
        allergies: ["Dairy"],
        pairings: [
          "cloudy-bay-sauvignon-blanc",
          "grilled-branzino",
      ...
      },
      {
        ...
        preparationNotes:
          "Baked fresh—allow 20 minutes. Best enjoyed warm with the cold cinnamon ice cream for temperature contrast. A perfect autumn dessert, though beloved year-round.",
      ...
      },
      {
        ...
        preparationNotes:
          "Must be ordered in advance—requires exactly 20 minutes to bake. Begins to deflate immediately upon leaving the oven, so must be served and eaten right away. The crème anglaise is poured into the center at the table.",
        allergies: ["Dairy", "Egg"],
        pairings: [
          "venison-medallions",
          "screaming-eagle-cabernet",
      ...
      },
      {
        ...
        preparationNotes:
          "Choux shells are baked fresh each service. The warm chocolate sauce contrasts with the cold pastry cream for an indulgent combination. Perfect for sharing or enjoying solo.",
        allergies: ["Dairy", "Egg", "Gluten"],
      ...
      },
      {
        ...
        preparationNotes:
          "Assembled to order to maintain pastry crispness. The caramelized top is done with a blowtorch. Eat immediately—the pastry softens over time. A dessert that showcases technical excellence.",
        allergies: ["Dairy", "Egg", "Gluten"],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        preparationNotes:
          "Serve well-chilled at 8–10°C. At least 8 years aging on lees. Perfect as an aperitif or paired with oysters, lobster, or foie gras. Made only in exceptional vintages.",
        allergies: ["Sulphites"],
        pairings: [
          "oysters-rockefeller",
          "lobster-thermidor",
      ...
      },
      {
        ...
        description:
          "The wine that created the Super Tuscan category. Deep ruby with purple edges, intense aromas of blackcurrant, plum, cedar, and dark chocolate. Full-bodied and powerful with firm tannins, concentrated fruit, and remarkable length. Combines power with elegance.",
        tags: ["Red", "Italian"],
        image:
        ...
        preparationNotes:
          "Decant 1 hour before serving. Serve at 16–18°C. Pairs excellently with grilled steaks and beef Wellington. Will reward patience with several decades of cellaring.",
        allergies: ["Sulphites"],
      ...
      },
      {
        ...
        description:
          "The wine that introduced the world to Marlborough Sauvignon Blanc. Pale straw with green highlights, bursting with passion fruit, grapefruit, lime, and gooseberry aromas. Medium-bodied with laser-like acidity and intense, pure fruit flavors.",
        tags: ["White", "Fresh"],
        image:
        ...
        preparationNotes:
          "Serve well-chilled at 6–8°C. Made primarily in stainless steel for fresh fruit character. Pairs beautifully with seafood, goat cheese, or as an aperitif. Best enjoyed within 2–3 years of vintage.",
        allergies: ["Sulphites"],
      ...
      },
      {
        ...
        preparationNotes:
          "Decant 30–60 minutes before serving. Serve at 16–18°C. Approachable now but will develop for 15–20 years. Pairs with Wagyu, lamb, or rich beef dishes.",
        allergies: ["Sulphites"],
      ...
      },
      {
        ...
        description:
          "Australia's most celebrated wine. Deep purple-black, extraordinarily intense with waves of blackberry, plum, licorice, dark chocolate, and espresso. Full-bodied and powerful with firm tannins. The finish seems endless—wines from the 1950s are still drinking beautifully.",
        tags: ["Red", "Bold"],
        image:
          "https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=800&q=80",
        images: [
        ...
        preparationNotes:
          "Decant 2–3 hours before serving for this young vintage. Serve at 16–18°C. Will develop for 30+ years. Pairs excellently with grilled meats, especially Tomahawk steak.",
        allergies: ["Sulphites"],
      ...
      },
      {
        ...
        description:
          "The purest expression of Chardonnay from Burgundy's northernmost region. Pale gold with aromas of green apple, lemon, and flinty mineral character. Medium-bodied with racy acidity and remarkable tension between fruit and minerality.",
        tags: ["White", "French"],
        image:
        ...
        preparationNotes:
          "Serve chilled at 10–12°C. No oak aging—pure fruit and mineral expression. Grown on Kimmeridgian limestone soil with fossilized oyster shells. Pairs beautifully with oysters, sea bass, and goat cheese.",
        allergies: ["Sulphites"],
        pairings: [
          "oysters-rockefeller",
          "chilean-sea-bass",
      ...
      },
      {
        ...
        description:
          "Made from Nebbiolo grapes, the 'king of wines and wine of kings.' Riserva designation means 5+ years aging including 3 in oak. Garnet color with complex aromas of red cherry, dried rose petals, tar, leather, and truffle. Full-bodied with firm tannins and high acidity.",
        tags: ["Red", "Italian"],
        image:
        ...
        preparationNotes:
          "Decant 2 hours before serving. Serve at 16–18°C. The tannins can be austere when young but integrate beautifully with age. Pairs excellently with Osso Buco and rich braised meats. Will evolve for 20+ years.",
        allergies: ["Sulphites"],
        pairings: [
          "osso-buco",
          "herb-crusted-lamb-rack",
      ...
      },
      {
        ...
        description:
          "The world's most recognized champagne house. Beautiful salmon-pink with aromas of wild strawberry, raspberry, and rose petals. Medium-bodied with creamy mousse, vibrant acidity, and fresh red fruit flavors. Incredibly versatile with food.",
        tags: ["Champagne", "Rosé"],
        image:
        ...
        preparationNotes:
          "Serve well-chilled at 6–8°C in flutes to showcase the bubbles. Incredibly versatile—pairs with tuna tartare, duck, desserts, or enjoyed as an aperitif. The salmon-pink color is achieved by adding still Pinot Noir wine.",
        allergies: ["Sulphites"],
        pairings: [
          "tuna-tartare",
          "duck-breast-a-lorange",
      ...
      },
      {
        ...
        description:
          "The most iconic and sought-after wine from Napa Valley. Almost pure Cabernet Sauvignon from a small Oakville vineyard. Deep black-purple, extraordinarily intense with ripe blackberry, cassis, espresso, and dark chocolate. Full-bodied with impossibly smooth, velvety tannins. The finish lasts for minutes.",
        tags: ["Red", "Collector"],
        image:
          "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=800&q=80",
        images: [
        ...
        preparationNotes:
          "Decant 1–2 hours before serving. Serve at 16–18°C. Many collectors prefer to drink it on its own to fully appreciate the complexity. Will age gracefully for decades. Extremely limited availability.",
        allergies: ["Sulphites"],
