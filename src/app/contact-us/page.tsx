...
export default function ContactPage() {
  ...
  return (
    ...
    >
      ...
      <PaddingContainer size="small" className="flex flex-col gap-20">
            ...
            <Form {...form}>
              ...
              >
                ...
                <Button
                  ...
                  className="flex flex-row gap-2 items-center justify-center bg-crimson-600 hover:bg-crimson-500 disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
        ...
        <GoogleMapComponent className="w-full h-[600px] rounded-2xl overflow-hidden border-2 border-burgundy-700 shadow-lg" />
      </PaddingContainer>
    </PageContainer>
  );
}
